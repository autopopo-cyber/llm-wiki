...
|---------|-------|-------------|-----|
| go2-convex-mpc | 96 | Convex MPC locomotion for Unitree Go2 (MuJoCo) | https://github.com/ami-iit/go2-convex-mpc |
| Awesome-Quadruped-with-Manipulator | 73 | Papers + projects on quadruped manipulation | https://github.com/robin-shaun/Awesome-Quadruped-with-Manipulator |
...
- basic-locomotion-isaaclab: IsaacLab sim-to-sim pipeline, could validate NAV_DOG policies
- terrain-aware-locomotion: Navigation + fall reduction — aligns with obstacle avoidance goal
- Awesome-Quadruped-with-Manipulator: Reference collection for manipulator integration (future)
